...
function renderNav(activePage = '') {
  const pages = [
    { href: '/sg/index.html', label: 'Home' },
    { href: '/sg/louisiana-real-estate.html', label: 'Louisiana Real Estate' },
    { href: '/sg/atlanta-real-estate.html', label: 'Atlanta Real Estate' },
    { href: '/sg/corporate.html', label: 'Corporate' },
    { href: '/sg/personal.html', label: 'Weddings & Personal' },
    { href: '/sg/pricing.html', label: 'Pricing' },
  ];
  ...
  document.getElementById('nav-placeholder').innerHTML = `
    <nav id="main-nav">
      <a href="/sg/index.html" class="nav-logo">SG Studios</a>
    ...
    <footer>
      <div class="footer-grid">
        ...
        <div class="footer-col">
          <h4>Portfolio</h4>
          <ul>
            <li><a href="/sg/louisiana-real-estate.html">Louisiana Real Estate</a></li>
            <li><a href="/sg/atlanta-real-estate.html">Atlanta Real Estate</a></li>
            <li><a href="/sg/personal.html">Weddings &amp; Personal</a></li>
            <li><a href="/sg/corporate.html">Corporate</a></li>
          </ul>
        </div>
        <div class="footer-col">
          <h4>Studio</h4>
          <ul>
            <li><a href="/sg/index.html#about">About</a></li>
            <li><a href="/sg/pricing.html">Pricing</a></li>
            <li><a href="/sg/index.html#contact">Contact</a></li>
